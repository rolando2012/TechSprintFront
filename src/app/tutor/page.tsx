...
export default function TutorPage() {
 ...
 async function checkValidacion(): Promise<boolean> {
  ...
  try {
    ...
    const startBolivia = createBoliviaDateTime(validacionEtapa.fechaInicio, validacionEtapa.horaInicio);
    const endBolivia = createBoliviaDateTime(validacionEtapa.fechaFin, validacionEtapa.horaFin);
    ...
    console.log('Fechas validación debug:', {
      fechaInicioOriginal: validacionEtapa.fechaInicio,
      horaInicioOriginal: validacionEtapa.horaInicio,
      ...
      await Swal.fire({
        ...
        html: `
          <div style="text-align: left; padding: 15px;">
            ...
            <div style="background-color: #e3f2fd; padding: 15px; border-radius: 8px; margin: 15px 0; border-left: 4px solid #1976d2;">
    ...
    if (nowBolivia > endBolivia) {
      ...
      await Swal.fire({
        ...
        html: `
          <div style="text-align: left; padding: 15px;">
            <p><strong>La etapa de Validación de Requisitos de "${competenciaNombre}" finalizó el:</strong></p>
            <div style="background-color: #fff3e0; padding: 15px; border-radius: 8px; margin: 15px 0; border-left: 4px solid #f57c00;">
