      ...
      <div className="text-center mb-6">
        ...
        <div className="space-y-2 text-sm text-gray-600">
          <div className="flex justify-between">
            <span className="text-xl font-medium">Período Actual</span>
            <span className="text-xl font-medium">Fecha Actual</span>
          </div>
        ...
        {/* Date Range */}
        {currentEtapa && (
          <div className="flex mt-4 text-md text-gray-600">
